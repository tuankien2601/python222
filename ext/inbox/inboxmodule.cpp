 ...
 *
 *  delete, address, content and time fail with:
 ...
 *    server is lost
 *    - Outbox, Sent, Drafts support could be added
...
new_inb_object(PyObject* /*self*/, PyObject /**args*/)
{
  ...
  TRAP(error, inbo->inbox = CInboxAdapter::NewL());
...
extern "C" {
  ...
  static const PyMethodDef inbox_methods[] = {
    {"Inbox", (PyCFunction)new_inb_object, METH_NOARGS, NULL},
    {NULL,              NULL}           /* sentinel */
  };
