...
The \module{audio} module enables recording and playing audio files. The 
\module{audio} module supports all the formats supported by the device, 
...
The following data items are available in \module{audio}:
